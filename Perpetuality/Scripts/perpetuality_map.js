...
perpetuality.map.prototype.makeItemizedPane = function(name, contentList, extraClass) {
  ...
  for (var i = 0; i < contentList.length; i++) {
    ...
    var contentItem = new perpetuality.map.ItemizedPaneItem();
    contentItem.title = content.title;
    contentItem.action = content.action;
    ...
    var jImage = $(image);
    jImage.addClass(content.imageClass);
    jImage.click(content.action);
